//
//  MedicationHomeDeliveryCell.swift
//  RvpMobile
//
...
protocol MedicationDeliveryCellDelegate: class {
...
class MedicationHomeDeliveryCell: UITableViewCell {
    ...
    weak var delegate: MedicationDeliveryCellDelegate?
    ...
    @IBAction func selectDeliveryAtBtnAction(_ sender: Any) {
        self.delegate?.selectDeliveryAtIndex(medicationCell: self, index: (btnDelivery?.tag)!)
    }
